...
export default function Hurdles({ updateScore }) {
  ...
  const end = () => {
    ...
    updateScore({ "110 Meter Hurdles": currentTime })
    setIsFinished(true)
  }
  ...
  const falseStart = () => {
    ...
    updateScore({ "110 Meter Hurdles": 999 })
  }
  ...
  return (
    <div className="sportsWrapper">
      ...
      <div className="instructions">
        <div className="name">110 Meter Hurdles</div>
        <div className="howTo">
          <div className="text">
      ...
      <div className="theSport">
        ...
        <div className="hurdleBoxes">{checkBoxes}</div>
      </div>
      <div className="score">
        <div className="time">
